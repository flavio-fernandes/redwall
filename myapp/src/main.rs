...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let block_addr: u32 = Ipv4Addr::new(0, 0, 0, 0).try_into()?;
    blocklist.insert(block_addr, 0, 0)?;

    let block_addr: u32 = Ipv4Addr::new(192, 168, 121, 34).try_into()?;
    blocklist.insert(block_addr, 0, 0)?;

    let block_addr: u32 = Ipv4Addr::new(10, 18, 97, 238).try_into()?;
    blocklist.insert(block_addr, 0, 0)?;
